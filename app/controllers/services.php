...
class services extends Controller
{
    ...
    public function index(): array
    {
        ...
        // GET request to fetch service-details.
        if (isset($_GET['details'])) {
            $details = $_GET['details'];

            $data['service-details'] = $userModel->getService($details);

            return ['content' => $this->view->render($data, 'home/service-details')];
        }else{
            return ['content' => $this->view->render($data, 'home/services')];
        }
    }
}

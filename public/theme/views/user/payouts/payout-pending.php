        ...
        <div class="containt-parent">
            <div class="main-containt">
                ...
                <div class="text-center" id="invest_list">
                    ...
                    <p class="mb-0 gilroy-medium text-gray-100 f-16 r-f-12 mt-2 tran-title p-inline-block">Below is the comprehensive list of all pending withdrawals currently on record.</p>
                </div>
    ...
    <div class="position-relative">
        <div class="containt-parent">
            <div class="main-containt">
                ...
                <div id="loadMorePendingWithdrawalsContainer">
                ...
                <?php if (count($data['get-withdrawals']) >= $PendingWithdrawalsPerPage): ?>
                <div class="mt-4">
                    <div class="text-center">
                        <button class="btn btn-sm btn-primary text-light loadMorePendingWithdrawals" data-page="2">
                            <span>Load More</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="row d-none" id="PendingWithdrawalsLastpage">

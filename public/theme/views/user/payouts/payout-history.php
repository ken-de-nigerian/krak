    ...
    <div class="position-relative">
        <div class="containt-parent">
            <div class="main-containt">
                ...
                <div id="loadMoreWithdrawalsContainer">
                ...
                <?php if (count($data['get-withdrawals']) >= $WithdrawalsPerPage): ?>
                <div class="mt-4">
                    <div class="text-center">
                        <button class="btn btn-sm btn-primary text-light loadMoreWithdrawals" data-page="2">
                            <span>Load More</span>
                        </button>
                    </div>
                </div>

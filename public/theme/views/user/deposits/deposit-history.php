    ...
    <div class="position-relative">
        <div class="containt-parent">
            <div class="main-containt">
                ...
                <div id="loadMoreDepositsContainer">
                ...
                <?php if (count($data['get-deposits']) >= $DepositsPerPage): ?>
                <div class="mt-4">
                    <div class="text-center">
                        <button class="btn btn-sm btn-primary text-light loadMoreDeposits" data-page="2">
                            <span>Load More</span>
                        </button>
                    </div>
                </div>

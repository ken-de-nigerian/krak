    ...
    <div class="containt-parent">
        <div class="main-containt">
            ...
            <div class="bg-white pxy-62 shadow" id="depositCreate">
                ...
                <p class="mb-0 text-center f-14 gilroy-medium text-gray dark-p mt-20">You can deposit your wallets using our popular payment methods. Fill the details correctly &amp; the amount you want to deposit.</p>

                <form id="checkout-form">
                    <!-- Amount -->
                    <div class="mt-20 label-top">
                        <label class="gilroy-medium text-gray-100 mb-2 f-15" for="checkout-details">Amount</label>
                        <input type="text" class="form-control input-form-control apply-bg l-s2" id="checkout-details" value="<?= isset($data['deposit-details']['amount']) ? e(number_format($data['deposit-details']['amount'], 2)) : '' ?>" readonly>
                    </div>
                    ...
                    <?php if (empty($data['get-gateway'])): ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mt-20 param-ref d-none">
                                    <label class="gilroy-medium text-warning mb-2 f-15">Payment Method are currently inactive.</label>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mt-20 param-ref">
                                    <label class="gilroy-medium text-gray-100 mb-2 f-15" for="method_code">Payment Method</label>
                    ...
                    <div class="d-grid">
                        <?=$this->token()?>
                        <button type="submit" class="btn btn-lg btn-primary mt-4" id="checkoutBtn" data-deposit="<?=e($data['deposit-details']['depositId'])?>">

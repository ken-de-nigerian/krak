    ...
    <div class="containt-parent">
        <div class="main-containt">
            ...
            <div class="bg-white pxy-62 shadow" id="sendMoneyCreate">
                ...
                <p class="mb-0 text-center f-14 gilroy-medium text-gray dark-p mt-20">Enter your recipients email address &amp; then add an amount. You can also provide a note for reference.</p>

                <form id="send-money-form">
                    <!-- Recipient -->
                    <div class="mt-28 label-top">
                        <label class="gilroy-medium text-gray-100 mb-2 f-15" for="receiver">Recipient</label>
                        <input type="text" class="form-control input-form-control apply-bg" name="receiver" id="receiver" placeholder="Please enter valid email" autocomplete="off">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="label-top mt-20">
                                ...
                                <span id="amount-limit-error" class="error"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid">
                        <?=$this->token()?>
                        <button type="submit" class="btn btn-lg btn-primary mt-4" id="sendMoneyBtn">

                            <span class="px-1">Proceed</span>

                            <span id="sendMoneySvgIcon">

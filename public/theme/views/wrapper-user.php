...
<html lang="en" class="scrol-pt">
    <head>
        ...
        <link rel="stylesheet" href="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/dist/plugins/select2-4.1.0-rc.0/css/select2.min.css" />
        <link rel="stylesheet" href="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/user/templates/css/style.min.css" />
        <!-- end css -->
    ...
    <body>
        ...
        <div class="my-container active-cont bg-white-50">
            ...
            <footer class="d-flex align-items-center justify-content-between bg-white w-100 px-4 footer-sec">
                <div class="res-order d-flex align-items-center">
                    <p class="mb-0 gilroy-medium">Copyright &copy; <?php echo date("Y")  ?>&nbsp;<a href="<?=$this->siteUrl()?>" class="link-text"><?=e($this->siteSettings('sitename'))?></a>&nbsp;|&nbsp;All Rights Reserved.</p>
                </div>
            </footer>
            <!-- end footer -->
        </div>
        ...
        <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/dist/libraries/bootstrap-5.0.2/js/bootstrap.bundle.min.js"></script>
        <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/dist/plugins/select2-4.1.0-rc.0/js/select2.min.js"></script>
        <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/user/templates/animation/lottie-player.min.js"></script>
        <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/user/templates/js/main.min.js"></script>
        <script src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/js/countdown.min.js"></script>
        <!-- end js -->

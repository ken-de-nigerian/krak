                ...
                <div class="auth-section signin-top d-flex align-items-center">
                      <div class="auth-module">
                        <form id="resetPasswordForm">
                            ...
                            <input type="hidden" id="id" name="id" value="<?= e($data['url_one']) ?>">
                            <input type="hidden" id="token" name="token" value="<?= e($data['url_two']) ?>">

                            <div class="auth-module-header">
                                <p class="mb-0 text-start auth-title">Reset Password.</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control input-form-control" id="confirmPassword" placeholder="Confirm Password" name="confirmPassword" autocomplete="off">
                                    </div>

                                    <div class="d-grid mb-3 mb-3p">
                                        <?=$this->token()?>
                                        <button class="btn btn-lg btn-primary" type="submit" id="resetPasswordBtn" data-id="<?= e($data['url_one']) ?>" data-token="<?= e($data['url_two']) ?>">

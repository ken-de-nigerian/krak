                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control input-form-control" id="firstname" name="firstname" value="<?=$data['user']->givenName?>" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control input-form-control" id="lastname" name="lastname" value="<?=$data['user']->familyName?>" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control input-form-control" id="email" name="email" value="<?=$data['user']->getEmail?>" autocomplete="off">

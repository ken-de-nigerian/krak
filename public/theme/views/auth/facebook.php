                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control input-form-control" id="firstname" name="firstname" value="<?=e($data['user']['firstname'])?>" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control input-form-control" id="lastname" name="lastname" value="<?=e($data['user']['lastname'])?>" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control input-form-control" id="email" name="email" value="<?=e($data['user']['email'])?>" autocomplete="off">
                                        <span id="email-error"></span>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label class="form-label" for="phone">Phone</label>
                                        <input type="tel" class="form-control" id="phone" value="<?= $data['user']->phoneNumber ?? null ?>" autocomplete="off">

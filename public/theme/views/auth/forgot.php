                ...
                <div class="bg-pattern">
                    <div class="bg-content">
                        <div class="d-flex justify-content-start">
                            <div class="logo-div">
                                <a href="<?=$this->siteUrl()?>"><img src="<?=$this->siteUrl().'/'.PUBLIC_PATH.'/'.UPLOADS_PATH?>/logo/<?=e($this->siteSettings('logo'))?>" alt="Brand Logo" style="width: 200px;"></a>
                            </div>
                        </div>
                    ...
                    <div class="auth-module">
                        <form id="forgot-form">
                            <div class="auth-module-header">
                                ...
                                <p class="mb-0 text-start auth-title mt-20">Forgot Password?</p>
                                <p class="mb-0 auth-text text-start mt-12 leading-24">Please enter your email address associated with your account to receive a verification code.</p>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="email-box indent">
                                            <input type="email" class="form-control input-form-control" placeholder="Enter your email" name="email" id="email" autocomplete="off">
                                    ...
                                    <div class="d-grid mb-3 mb-3p">
                                        <?=$this->token()?>
                                        <button class="btn btn-lg btn-primary" type="submit" id="forgotBtn">

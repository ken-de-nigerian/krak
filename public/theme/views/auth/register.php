        ...
        <div class="row">
                    ...
                    <div class="bg-content">
                        ...
                        <div class="transaction-image">
                            <div class="static-image">
                                <img class="img img-fluid" src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/frontend/templates/images/login/signup-static-img.svg">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-12 col-xl-7">
                <div class="auth-section d-flex align-items-center create-account">
                    <div class="auth-module" style="margin-top: 50px !important;">
                        <div class="d-flex align-items-center back-direction mb-2 back-signin">
                            <a href="<?=$this->siteUrl()?>" class="d-inline-flex align-items-center back-btn">
                        ...
                        <form class="form-horizontal" id="register-form">
                            ...
                            <?php
                                ...
                                // Check if referral ID is already stored in session
                                $referralId = isset($_SESSION['referral_id']) ? htmlspecialchars($_SESSION['referral_id']) : '';

                                // Output the referral ID in the input field
                                echo '<input type="hidden" name="referralId" value="' . $referralId . '">';
                            ...
                            <div class="auth-module-header">
                                ...
                                <p class="mb-0 text-start auth-text mt-12">Already have an account? <a href="<?=$this->siteUrl()?>/login">Sign in here</a></p>
                            </div>

                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="firstname">First Name <span class="star">*</span></label>
                                        <input type="text" class="form-control input-form-control" id="firstname" name="firstname" placeholder="Firstname" autocomplete="off">
                                    </div>
                                </div>

                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="lastname">Last Name <span class="star">*</span></label>
                                        <input type="text" class="form-control input-form-control" id="lastname" name="lastname" placeholder="Lastname" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control input-form-control" id="email" name="email" placeholder="Email address" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div id="password-div" class="position-relative">
                                            ...
                                            <input type="password" class="form-control input-form-control" name="password" id="password" placeholder="Password" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3" id="confirm-password-div">
                                        ...
                                        <input type="password" class="form-control input-form-control" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password" autocomplete="off">
                                        <span id="password-error"></span>
                                    </div>

                                    <div class="policy d-flex justify-content-center mt-4 mb-4">
                                        <p class="mb-0">By signing up, you agree to our Terms, Data Policy and Cookie Policy.</p>
                                    </div>
                                    
                                    <div class="d-grid mb-3 mb-3p">
                                        <?=$this->token()?>
                                        <button class="btn btn-lg btn-primary" type="submit" id="registerBtn">

                                            <span class="px-1">Continue</span>

                                            <span id="rightAngle">
                                                <svg class="position-relative ms-1" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">

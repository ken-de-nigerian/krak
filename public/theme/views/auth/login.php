                    ...
                    <div class="bg-content">
                        ...
                        <div class="transaction-image">
                            <div class="static-image">
                                <img class="img img-fluid" src="<?=$this->siteUrl()?>/<?=$this->themePath()?>/assets/frontend/templates/images/login/signin-static.svg" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="auth-module">
                        ...
                        <form id="login">
                            ...
                            <div class="auth-module-header">
                                ...
                                <p class="mb-0 text-start auth-text mt-12">Don’t have an account?<a href="<?=$this->siteUrl()?>/register"> Sign up here</a></p>
                            </div>

                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="email">Email Address <span class="star">*</span></label>
                                        <input type="email" class="form-control input-form-control" placeholder="Email Address" name="email" id="email" autocomplete="off">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div id="show_hide_password" class="position-relative">
                                            <input type="password" class="form-control input-form-control" id="password" placeholder="Password" name="password" autocomplete="off">
                                    ...
                                    <div class="form-check custom-form-check mb-3 d-flex justify-content-between align-items-center">
                                        <div>
                                            <input class="form-check-input me-2" name="remember" type="checkbox" id="remember_me" autocomplete="off">
                                            <label class="form-check-label me-3" for="remember_me">Remember me</label>
                                        </div>
                                        <p class="text-end mb-0"><a href="<?=$this->siteUrl()?>/forgot" class="auth-text">Forget password?</a></p>
                                    </div>
                                    
                                    <div class="d-grid mb-3 mb-3p">
                                        <?=$this->token()?>
                                        <button id="loginBtn" class="btn btn-lg btn-primary" type="submit">

...
<article>
    ...
    <div>
        <p>
            Dear <?=e($data['user']['firstname'])?> <?=e($data['user']['lastname'])?>,
            <br>
            Regrettably, your account has been suspended due to violations of our terms. We uphold strict integrity and regulatory compliance standards. Your recent actions have fallen short of these expectations.
        </p>
    </div>
</article>
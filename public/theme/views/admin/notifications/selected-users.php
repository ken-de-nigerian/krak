    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="px-4">
                        <div class="row">
                            <div class="col-xxl-5 align-self-center">
                                <div class="py-4">
                                    <h4 class="display-6 coming-soon-text">Send Email - Selected Users</h4>
                ...
                <form id="notify-selected-form">
                    <div class="row justify-content-evenly mb-2">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Notification To Selected Users</h4>
                                <div class="col-sm-auto ms-auto">
                                    <div class="list-grid-nav hstack gap-1">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            ...
                                            <li><a class="dropdown-item active" href="<?=$this->siteUrl()?>/admin/notify/selected-users">Selected Users</a></li>
                                            ...
                                            <li><a class="dropdown-item" href="<?=$this->siteUrl()?>/admin/notify/users-with-initiated-deposits">Users With Initiated Deposits</a></li>
                                    ...
                                    <div class="row gy-4">
                                        <div class="col-xxl-6 col-md-6">
                                            <div class="form-floating">
                                                <select class="js-example-basic-single form-select" id="users" multiple="multiple" name="users[]" data-width="100%">
                                                    <?php foreach ($data['users'] as $user): ?>
                                                        <option value="<?=e($user["email"])?>"><?=e($user["firstname"])?> <?=e($user["lastname"])?></option>
                                                    <?php endforeach ?>
                                                </select>
                                                <label for="users" id="users-label">Select Users</label>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        ...
                                        <div class="col-xxl-12 col-md-12">
                                            <?=$this->token()?>
                                            <button id="notifySelectedBtn" class="btn btn-primary waves-effect waves-light w-100">Send Email</button>
                                        </div>
                                        <!--end col-->
                                    </div>
                                    <!--end row-->

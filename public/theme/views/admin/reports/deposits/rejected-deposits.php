        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="px-4">
                        <div class="row">
                            <div class="col-xxl-5 align-self-center">
                                <div class="py-4">
                                    <h4 class="display-6 coming-soon-text">Rejected Deposits</h4>
                                    <p class="text-success fs-15 mt-3">You have full control to monitor all rejected deposits on your site.</p>
                                    ...
                                    <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                        <div class="empty-notification-elem">
                                            ...
                                            <div class="text-center pb-5 mt-2">
                                                <h6 class="fs-18 fw-semibold lh-base">No rejected deposits found.</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <div class="col-xxl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Rejected Deposits History</h4>
                                <div class="col-sm-auto ms-auto">
                                    <div class="list-grid-nav hstack gap-1">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            ...
                                            <li><a class="dropdown-item active" href="<?=$this->siteUrl()?>/admin/deposits_rejected">Rejected</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-card">
                                    <table class="table table-borderless align-middle" id="loadMoreRejectedDepositsContainer">
                    ...
                    <!-- end row -->
                    <?php if (count($data['deposits']) >= $RejectedDepositsPerPage): ?>
                    <div class="text-center mb-3 mt-3">
                        <button class="btn btn-primary waves-effect waves-light loadMoreRejectedDeposits" data-page="2">Load More </button>
                    </div>
                    <?php endif; ?>

                    <div class="row d-none" id="RejectedDepositsLastpage">

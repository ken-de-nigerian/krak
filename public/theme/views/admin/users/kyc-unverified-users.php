        ...
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="px-4">
                        <div class="row">
                            <div class="col-xxl-5 align-self-center">
                                <div class="py-4">
                                    <h4 class="display-6 coming-soon-text">KYC Unverified Users</h4>
                ...
                <?php else: ?>
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-2" action="<?=$this->siteUrl()?>/admin/kyc_unverified" method="GET">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-auto ms-auto">
                                    <div class="list-grid-nav hstack gap-1">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            ...
                                            <li><a class="dropdown-item" href="<?=$this->siteUrl()?>/admin/banned">Banned Users</a></li>
                                            <li><a class="dropdown-item active" href="<?=$this->siteUrl()?>/admin/kyc_unverified">Kyc Unverified</a></li>
                    ...
                    <div id="loadMoreKYCUnverifiedUsersContainer">
                    ...
                    <!-- end col -->
                    <?php if (count($data['users']) >= $KYCUnverifiedUsersPerPage): ?>
                    <div class="text-center mb-3 mt-3">
                        <button class="btn btn-primary waves-effect waves-light loadMoreKYCUnverifiedUsers" data-page="2">Load More </button>
                    </div>
                    <?php endif; ?>

                    <div class="row d-none" id="KYCUnverifiedUsersLastpage">
